...
"Usage: [T,rhs] = build_bvp( a, b, ya, yb, N )\n" \
"\n" \
"where\n" \
...
mexFunction( int nlhs, mxArray       *plhs[],
  ...
  try {
    ...
    if ( nlhs != 2 || nrhs != 5 ) throw MEX_ERROR_MESSAGE;

    #define CMD "[T,rhs] = build_bvp1( a, b, ya, yb, N ): "
    ...
    */
    ...
    real_type * R = createMatrixValue( arg_out_1, N, 1 );
